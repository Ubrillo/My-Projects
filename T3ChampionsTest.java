...
public class T3ChampionsTest {
    ...
    public void isChampionTest()
    {
        ...
        assertTrue("Flimsi should be in reserve.", actual);
    }
    ...
    public void getChampionDetailsTest(){
        ...
        assertTrue("Details for Argon should be correct.", actual);
    }
    ...
    public void championInReserveGanfrankDisplayed() {
        ...
        assertTrue("Champion details should be displayed correctly in reserved.", actual);
    }
    ...
    public void ChampionInReserveRudolfDisplayed() {
        ...
        boolean actual = containsText(result,xx );
        assertTrue("Champion details should be displayed correctly in reserve.", actual);
    }
